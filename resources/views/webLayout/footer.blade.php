...
<footer class="site-footer"
    style="background-image: url({{ asset('allAssets/web/assets/images/resources/logo/clr-pat.png') }})">
    <div class=" container">
        <div class="row">
                    ...
                    <ul class="list-unstyled">
                        <li>
                            ...
                            <div class="footer-widget_about_text">
                                <a href="mailto:needhelp@herbnest.com">needhelp@herbnest.com</a>
                            </div>
                        </li>
                        <li>
                            <div class="footer-widget_about_icon">
            ...
            <div class="col-xl-2 col-lg-6 col-md-6">
                <div class="footer-widget__column footer-widget__explore wow fadeInUp animated" data-wow-delay="200ms">
                    ...
                    <ul class="footer-widget__explore_list list-unstyled">
                        ...
                        <li><a href="history.html">{{ __('Certificate') }}</a></li>
            ...
            <div class="col-xl-3 col-lg-6 col-md-6">
                <div class="we_are_commited_image_box">
                    <img src="{{ asset('allAssets/web/assets/images/resources/inspiring_solutuions_one_bg.jpg') }}"
                        alt="">
    ...
    <div class="mobile-nav__content">
        ...
        <ul class="mobile-nav__contact list-unstyled">
            <li>
                ...
                <a href="mailto:needhelp@azino.com">herbnest_eg.com</a>
            </li>
            <li>
        ...
        <div class="mobile-nav__top">
            <div class="mobile-nav__language">
                <img src="{{ asset('allAssets/web/assets/images/resources/'.app()->getLocale().'.jpg') }}" alt="" />
