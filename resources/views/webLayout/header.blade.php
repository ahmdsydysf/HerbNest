...
<head lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="{{ asset('allAssets/web/assets/images/favicons/fav.png') }}" />
    <link rel="icon" type="image/png" sizes="32x32"
        href="{{ asset('allAssets/web/assets/images/favicons/fav.png') }}" />
    <link rel="icon" type="image/png" sizes="16x16"
        href="{{ asset('allAssets/web/assets/images/favicons/fav.png') }}" />
    <link rel="manifest" href="{{ asset('allAssets/web/assets/images/favicons/fav.png') }}" />
...
<body>
    <div class="preloader">
        <img src="{{ asset('allAssets/web/assets/images/resources/logo/w-loader.png') }}" class="preloader__image"
            alt="" />
    </div>
    <!-- /.preloader -->
                                ...
                                <ul class="list-unstyled">
                                    ...
                                    <li>
                                        ...
                                        <div class="text">
                                            <p>{{ __('Send Email') }}</p>
                                            <h5>
                                                <a href="mailto:herbnest_eg.com">herbnest_eg.com</a>
                                            </h5>
                                        </div>
                                    </li>
                                    <li>
                                    ...
                                    <li>
                                        ...
                                        <div class="mobile-nav__language">
                                            <img src="{{ asset('allAssets/web/assets/images/resources/'.app()->getLocale().'.jpg') }}"
                                                alt="" />
