        ...
        <div class="swiper-wrapper">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-2-2.jpg') }});
                "></div>
                <div class="container">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-1-1.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-1-2.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-1-3.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-2-1.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-3-1.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-3-2.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="swiper-slide">
                <div class="image-layer" style="
                  background-image: url({{ asset('allAssets/web/assets/images/main-slider/slider-3-3.jpg') }});
                "></div>
                <div class="container">
                    <div class="swiper-slide-inner">
                        <div class="row">
            ...
            <div class="col-xl-12">
                <div class="cta_one_inner">
                    <div class="cta_one_left_text">
                        <h3>{{ __('A High Quality Herbs & Spices') }}</h3>
                    </div>
            ...
            <div class="col-xl-6">
                <div class="welcome_one_left">
                    <div class="welcome_one_left_image">
                        <img src="{{ asset('allAssets/web/assets/images/resources/welcome-1-img-1.jpg') }}" alt="" />
                        <ul class="counter_one list-unstyled">
                            <li class="counter_one_single">
                                <img src="{{ asset('allAssets/web/assets/images/resources/cer-2.png') }}" alt=""
                                    srcset="">
                            </li>
                            <li class="counter_one_single">
                                <div class="counter_one_experience">
                                    <h2>
                                        <img src="{{ asset('allAssets/web/assets/images/resources/cer-1.png') }}" alt=""
                                            srcset="">
                            ...
                            <li class="counter_one_single">
                                <img src="{{ asset('allAssets/web/assets/images/resources/cer-3.png') }}" alt=""
                                    srcset="">
        ...
        <div class="row">
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="our_services_one_single wow fadeInUp">
                    <div class="our_services_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/service/service-1-img-1.jpg') }}" alt="" />
                        <div class="our_services_icon">
                            <span><img src="{{ asset('allAssets/web/assets/images/service/qu.png') }}" alt=""
                                    srcset=""></span>
                        </div>
                    </div>
                    <div class="our_services_one_content">
                        <h3>
                            <a href="services-details.html">{{ __('Quality Assurance') }} </a>
                        </h3>
                        <p>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="our_services_one_single wow fadeInUp" data-wow-delay="100ms">
                    <div class="our_services_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/service/service-1-img-2.jpg') }}" alt="" />
                        <div class="our_services_icon">

                            <span><img src="{{ asset('allAssets/web/assets/images/service/cs.png') }}" alt=""
                                    srcset=""></span>
                        </div>
                    </div>
                    <div class="our_services_one_content">
                        <h3>
                            <a href="services-details.html">{{ __('Customer Support') }}
                            </a>
                        </h3>
                        <p>
            ...
            <div class="col-xl-4 col-lg-4">
                ...
                <div class="our_services_one_single wow fadeInUp" data-wow-delay="200ms">
                    <div class="our_services_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/service/service-1-img-3.jpg') }}" alt="" />
                        <div class="our_services_icon">
                            <span><img src="{{ asset('allAssets/web/assets/images/service/mr.png') }}" alt=""
                                    srcset=""></span>
                    ...
                    <div class="our_services_one_content">
                        <h3>
                            <a href="services-details.html">{{ __('Market Insights and Trends') }}</a>
                        </h3>
                        <p>
...
<section class="inspiring_solutuions_one jarallax" data-jarallax data-speed="0.3" data-imgPosition="50% 0%">
    <img src="{{ asset('allAssets/web/assets/images/resources/inspiring_solutuions_one_bg.jpg') }}" alt=""
                ...
                <a href="contact.html" class="thm-btn">Get a free quote</a>
                    ...
                    <div class="inspiring_solutuions_one_left_bottom">
                        <div class="inspiring_solutuions_one_left_bottom_image">
                            <img src="{{ asset('allAssets/web/assets/images/resources/inspiring_solutuions_1-img-1.jpg') }}"
                                alt="" />
                        </div>
...
<section class="brand-one">
    <div class="container">
        <div class="brand-one__carousel owl-carousel thm__owl-carousel owl-theme"
            ...
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/1200px-USDA_organic_seal.svg.png') }}"
                    alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/1547184389857.jpg') }}" alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/depositphotos_51834883-stock-illustration-kosher-stamp.jpg') }}"
                    alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/Fairtrade-logo.jpg') }}" alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/RA_Seal_Core_Green_and_White_RGB-e1602838216833.png') }}"
                    alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/ISO-Logo-22000-2005.png') }}" alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/Screen-Shot-2020-10-22-at-1.08.49-AM.png') }}"
                    alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/images.jpeg') }}" alt="" />
            </div>
            <!-- /.item -->
            <div class="item">
                <img src="{{ asset('allAssets/web/assets/images/certificate/0001_brc-logo-green-1_1649070677.png') }}"
                    alt="" />
            </div>
            <!-- /.item -->
    ...
    <div class="container">
        ...
        <div class="row filter-layout masonary-layout">
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item inds cons elec">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Amchur Powder .jpg') }}" alt="" />
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item elec cons">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Coriander Powder .jpg') }}" alt="" />
                        <div class="our_projects_one_icon">
                            <a href="projects-details.html"><span class="flaticon-right-arrow"></span></a>
                        </div>
                        <div class="our_projects_one_text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item elec fac">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Cumin Powder .jpg') }}" alt="" />
                        <div class="our_projects_one_icon">
                            <a href="projects-details.html"><span class="flaticon-right-arrow"></span></a>
                        </div>
                        <div class="our_projects_one_text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item inds cons">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Turmeric Powder .jpg') }}" alt="" />
                        <div class="our_projects_one_icon">
                            <a href="projects-details.html"><span class="flaticon-right-arrow"></span></a>
                        </div>
                        <div class="our_projects_one_text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item fac cons">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Fenugreek Powder.jpg') }}" alt="" />
                        <div class="our_projects_one_icon">
                            <a href="projects-details.html"><span class="flaticon-right-arrow"></span></a>
                        </div>
                        <div class="our_projects_one_text">
            ...
            <div class="col-xl-4 col-lg-4 col-md-6 filter-item inds elec">
                ...
                <div class="our_projects_one_single">
                    <div class="our_projects_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/project/Red Chilli Flakes .jpg') }}" alt="" />
                        <div class="our_projects_one_icon">
                            <a href="projects-details.html"><span class="flaticon-right-arrow"></span></a>
                        </div>
                        <div class="our_projects_one_text">
...
<!-- <section class="testimonails_one" style="
          background-image: url(assets/images/testimonials/testimonails_1-bg.jpg') }});
        ">
      <div class="container">
        <div class="row">
        ...
        <div class="swiper-wrapper">
          <div class="swiper-slide">
            ...
            <div class="testimonails_one_single">
              ...
              <div class="testimonails_one_image">
                <img src="{{ asset('allAssets/web/assets/images/testimonials/testimonails_1-img-1.jpg') }}" alt="" />
              </div>
            </div>
          </div>
          ...
          <div class="swiper-slide">
            ...
            <div class="testimonails_one_single">
              ...
              <div class="testimonails_one_image">
                <img src="{{ asset('allAssets/web/assets/images/testimonials/testimonails_1-img-2.jpg') }}" alt="" />
              </div>
            </div>
          </div>
...
<section class="two_sections_one">
    <div class="two_sections_one_map" style="
            background-image: url({{ asset('allAssets/web/assets/images/resources/two_sections-1-map.png') }});
          "></div>
    <div class="container">
        <div class="row">
            <div class="col-xl-5 col-lg-6">
                <div class="two_sections_one_left">
                    <ul class="list-unstyled">
                        <li>
                            <div class="icon_box">
                                <img src="{{ asset('allAssets/web/assets/images/resources/expert.png') }}" alt=""
                                    srcset="">
                            </div>
                        ...
                        <li>
                            <div class="icon_box">
                                <img src="{{ asset('allAssets/web/assets/images/resources/fast-delivery.png') }}" alt=""
                                    srcset="">
                        ...
                        <li>
                            <div class="icon_box">
                                <img src="{{ asset('allAssets/web/assets/images/resources/quality-control.png') }}"
                                    alt="" srcset="">
            ...
            <div class="col-xl-7 col-lg-6">
                <div class="two_sections_one_right">
                    ...
                    <div class="two_sections_one_image">
                        <img src="{{ asset('allAssets/web/assets/images/resources/callcenter.jpg') }}" alt="" />
                        <div class="two_sections_one_phone_number">
                            <div class="icon">
                                <img src="{{ asset('allAssets/web/assets/images/resources/whatsapp.png') }}" alt=""
                                    srcset="">
                            </div>
        ...
        <div class="row">
          <div class="col-xl-4 col-lg-4">
            ...
            <div class="blog_one_single wow fadeInLeft" data-wow-duration="1500ms" data-wow-delay="0ms">
              <div class="blog_one_image">
                <img src="{{ asset('allAssets/web/assets/images/blog/blog-1-img-1.jpg') }}" alt="" />
          ...
          <div class="col-xl-4 col-lg-4">
            ...
            <div class="blog_one_single wow fadeInDown" data-wow-duration="1500ms" data-wow-delay="100ms">
              <div class="blog_one_image">
                <img src="{{ asset('allAssets/web/assets/images/blog/blog-1-img-2.jpg') }}" alt="" />
                <div class="blog_one_date_box">
                  <p>
                    20 <br />
                    Oct
          ...
          <div class="col-xl-4 col-lg-4">
            ...
            <div class="blog_one_single wow fadeInRight" data-wow-duration="1500ms" data-wow-delay="200ms">
              <div class="blog_one_image">
                <img src="{{ asset('allAssets/web/assets/images/blog/blog-1-img-3.jpg') }}" alt="" />
                <div class="blog_one_date_box">
                  <p>
                    20 <br />
                    Oct
          ...
          <div class="col-xl-12">
            <div class="call_one_inner">
              <div class="call_one_image">
                <img src="{{ asset('allAssets/web/assets/images/resources/call_1-img-1.jpg') }}" alt="" />
              </div>
